        ...
        <Grid spacing={2} container className={resultClasses.root}>
          <Grid item xs={3}>
            ...
            <Typography className={resultClasses.paper}>
              ...
              {props.wordOptions.quotes === false &&
              props.wordOptions.punctuation === false
                ? "Words"
                : ""}
            </Typography>
          </Grid>
          <Grid item xs={3}>
            ...
            <Typography className={resultClasses.paper}>
              ...
              {props.wordOptions.seconds30 === false &&
              props.wordOptions.seconds60 === false
                ? "N/A"
                : ""}
            </Typography>
          </Grid>
