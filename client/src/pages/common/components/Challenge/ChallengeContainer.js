...
export const ChallengeContainer = (props) => {
  ...
  props = {title: "Typing Challenge", ...props};
  return (
                ...
                >
                  {row.map((item) => {
                    if (
                      ...
                      props.selectedKey === item.upperKey
                    ) {
                    ...
                    return (
                      <Grid item key={item.key}>
                        <Paper
                          elevation={0}
                          className={
                            item.key === " " ? classes.spacebar : classes.paper
                          }
                          style={{
                            backgroundColor:
                              props.selectedKey === item.key ||
        ...
        <Box m={1}>
          ...
          >
            ...
            <Grid item>
              ...
              />
              <PanToolIcon
                style={{fontSize: 200, float: "right", color: secondaryColor}}
              />
            </Grid>
          </Grid>
        </Box>
