        ...
        <Grid item xs={10} lg={4}>
          <Box m={3} style={{ color: "white" }}>
            ...
            <Typography component="h4" variant="h6">
              Hype Type is the fastest way to test and increase your typing
              speed.
            </Typography>
          ...
          <Grid item xs={12} md={4}>
            <Box m={3} style={{ textAlign: "center" }}>
              ...
              <Typography component="p" variant="body1">
                <b>Save time.</b> Learning to type faster will save you time in
                your daily life at work, school, and anywhere you need to type.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box m={3} style={{ textAlign: "center" }}>
              ...
              <Typography component="p" variant="body1">
                <b>Be more productive.</b> Everyone is looking for ways to be
                more productive. Typing faster is a simple way to get more done.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box m={3} style={{ textAlign: "center" }}>
              ...
              <Typography component="p" variant="body1">
                <b>Improve your focus.</b> Rather than focusing on where your
                fingers should go, you can focus on the important things.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box m={3} style={{ textAlign: "center" }}>
              ...
              <Typography component="p" variant="body1">
                <b>Have better accuracy.</b> When you practice typing, not only
                will you type faster, but you will also type with fewer errors.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box m={3} style={{ textAlign: "center" }}>
              ...
              <Typography component="p" variant="body1">
                <b>Find new opportunities.</b> If you are searching for new
                opportunities, typing fast is a desirable skill to employers.
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box m={3} style={{ textAlign: "center" }}>
              ...
              <Typography component="p" variant="body1">
                <b>And it's so easy to use!</b> To type with Hype Type, all you
                need is a keyboard and a web browser.
              </Typography>
            </Box>
          </Grid>
        </Grid>
